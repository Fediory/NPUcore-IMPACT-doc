...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/10-04-测例ELF.jpg}
	\caption{测例 ELF 大小}
	\label{fig:ELF}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/10-04-k210内存空间.jpg}
	\caption{k210 内存使用情况}
	\label{fig:k210}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/10-04-Page fault.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/10-04-内存实验评估.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/10-04-SD卡驱动异常.jpg}
...
为了让 NPUcore 在读写 SD 失败后具有错误恢复的能力 ，我们在 SD 卡驱动程序中进行了完善，以提高 NPUcore 的稳定性。
