...
\begin{lstlisting}[language={Rust}, label={code:new\_bare}, caption={new\_bare}]
	impl MemorySet {
...
\begin{lstlisting}[language={Rust}, label={code:anonymous\_identical\_map}, caption={anonymous\_identical\_map}]
	macro_rules! anonymous_identical_map {
		($begin:expr,$end:expr,$permission:expr) => {
			memory_set
			.push(
...
\begin{lstlisting}[language={Rust}, label={code:map\_one}, caption={map\_one}]
	pub fn map_one(
	&mut self,
