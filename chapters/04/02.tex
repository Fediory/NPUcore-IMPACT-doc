...
\begin{lstlisting}[language={Rust}, label={code:new_bare}, caption={new\_bare}]
	impl MemorySet {
...
\begin{lstlisting}[language={Rust}, label={code:anonymous_identical_map}, caption={anonymous\_identical\_map}]
	macro_rules! anonymous_identical_map {
		($begin:expr,$end:expr,$permission:expr) => {
			memory_set
			.push(
